//
//  LoginWithMailScreemViewController.swift
//  Project X
//
...
final class LoginWithMailScreenViewController: UIViewController {
    ...
    private let continueButton: UIButton = {
        let button = PrimaryButton(text: "Продолжить", fillColor: .lavanderGrey, tintColor: .primaryPureWhite, borderColor: .duskGrey)
...
private extension LoginWithMailScreenViewController {
    func setupUI() {
        ...
        inputMailField.attributedPlaceholder = NSAttributedString(string: "Твой email", attributes: [
        ...
        inputPasswordField.attributedPlaceholder = NSAttributedString(string: "Family ID", attributes: [
            .foregroundColor: UIColor.duskGrey,
            .font: UIFont.robotoRegular14()
        ])
