...
extension UIFont {
    ...
    static func robotoRegular13() -> UIFont? {
        return UIFont.init(name: "Roboto-Regular", size: 13)
    }

    static func robotoRegular12() -> UIFont? {
    ...
    static func nexaDemoBold24() -> UIFont? {
        return UIFont.init(name: "NexaDemo-Bold", size: 24)
    }
